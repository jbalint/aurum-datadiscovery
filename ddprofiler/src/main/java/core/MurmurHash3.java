...
/**
 * The MurmurHash3 algorithm was created by Austin Appleby and placed in the public domain. This java port was authored by Yonik Seeley and also placed into the public domain. The
 ...
 * <p>
 * The 32 bit x86 version of this hash should be the fastest variant for relatively short keys like ids. murmurhash3_x64_128 is a good choice for longer strings or if you need more
 * than 32 bits of hash.
 * <p>
...
public final class MurmurHash3 {
	...
	/**
	 * Returns the MurmurHash3_x86_32 hash of the UTF-8 bytes of the String without actually encoding the string to a temporary buffer.  This is more than 2x faster than hashing
	 * the result of String.getBytes().
	 */
